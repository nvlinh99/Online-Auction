...
const productSample = {
  ...
  avatarUrl: imgSrc,
  imageUrls: [
    'https://cf.shopee.vn/file/62ed6299a25ad9bb9faa4f84f6b49421',
    'https://cdn.tgdd.vn/Products/Images/42/227900/xiaomi-poco-x3-220820-100857.jpg',
    'https://salt.tikicdn.com/ts/product/80/34/36/cfb8c025dc232930700cdf45d2d8a8de.png',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSP5TNJ35LYkPjENursH2xNBeVFhcUGBqs5dg&usqp=CAU',
  ],
...
export const productList = Array(10)
  .fill(0)
  .map((v, i) => {
    const data = _.cloneDeep(productSample)
    data.id = i
    return data
  })
